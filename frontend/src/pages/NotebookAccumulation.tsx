    ...
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="flex items-center gap-2">
        ...
        <Button
          variant="outline"
          size="sm"
          onClick={() => store.setFilter(categoryFilter ? JSON.stringify({ cond: { column: 'category', op: 'like', value: categoryFilter } }) : null)}
        >
          筛选
        </Button>
        <Button
          variant="outline"
          size="sm"
          onClick={() => { setCategoryFilter(''); store.setFilter(null); }}
        >
          全部
        </Button>
      </div>
