...
export const ArrowIcon: React.FC<ArrowIconProps> = ({ direction, className, size = 14 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** 返回/撤销（掉头箭头）图标 */
export const ReplyIcon: React.FC<IconProps> = ({ className, size = 16 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
/** 双箭头图标 */
export const DoubleArrowIcon: React.FC<ArrowIconProps> = ({ direction, className, size = 14 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** 提交（勾选）图标 */
export const SubmitIcon: React.FC<IconProps> = ({ className, size = 16 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
/** 批量更新（铅笔在堆叠的文件上）图标 */
export const BatchEditIcon: React.FC<IconProps> = ({ className, size = 16 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
  ...
  >
    ...
    {/* 第二个文件（堆叠效果） */}
    <path d="M4 6h-1a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2v-1" />
    {/* 铅笔 */}
    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" />
  </svg>
);
...
/** 全选（堆叠的文件上有对勾）图标 */
export const SelectAllIcon: React.FC<IconProps> = ({ className, size = 16 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
/** 全不选（堆叠的文件上有叉号）图标 */
export const DeselectAllIcon: React.FC<IconProps> = ({ className, size = 16 }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
